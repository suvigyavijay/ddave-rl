...
class CustomCNN(BaseFeaturesExtractor):
    ...
    def __init__(self, observation_space: spaces.Box, features_dim: int = 256):
        ...
        self.conv1 = nn.Conv2d(1, 16, kernel_size=(1, 1), stride=1, padding=1)  # Output size: (16, 11, 100)
        self.pool = nn.MaxPool2d(kernel_size=(1, 1), stride=2)  # Output size: (16, 5, 50)
        self.conv2 = nn.Conv2d(16, 32, kernel_size=(1, 1), stride=1, padding=1)  # Output size: (32, 5, 50)
